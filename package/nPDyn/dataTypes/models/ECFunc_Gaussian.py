...
class Model(DataTypeDecorator):
    """ This class stores data as resolution function related.
        It allows to perform a fit using a scaled Gaussian given by:
        ...
        A a scaling factor, shift a scalar to account for maximum not being at
        0 exactly, and bkgd a background term.
    ...
    def __init__(self, dataType):
        ...
        self.paramsNames = ["normF", "gauW", "shift", "bkgd"]


    def fit(self, p0=None, bounds=None):
        """ Uses Scipy's curve_fit routine to fit the pseudo-Voigt
            profile to the experimental data given in the argument resData.
    ...
    def model(self, x, normF, gauW, shift, bkgd):
        ...
        return (normF * np.exp(-((x - shift)**2) / (2 * gauW**2))
