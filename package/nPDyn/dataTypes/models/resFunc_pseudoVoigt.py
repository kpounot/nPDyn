...
from nPDyn.dataTypes.resType import DataTypeDecorator
...
class Model(DataTypeDecorator):
    ...
    def __init__(self, dataType):
        ...
        self.params     = None
        self.paramsNames = ["normF", "S", "lorW",
                            "gauW", "shift", "bkgd"]  # For plotting purpose
    ...
    def resFit(self, p0=None, bounds=None):
        """ Uses Scipy's curve_fit routine to fit the pseudo-Voigt profile
            ...
            Returns a list of fitted parameters for each scattering
            angle / q-value.
