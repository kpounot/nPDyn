...
def getD2Odata(volFraction=0.95):
    """ This script extract D2O background signal
        from IN6 measurements data.
        Then the D2O signal intensity is weighted by the given
        volume fraction of it in sample solution with default value
        being one for pure D2O.
        Eventually, linear interpolation is performed
    ...
    # Platform dependent way of return path
