...
def gamma(x, msd, beta, scaleF):
    """ This function can be used to fit elastic data. It makes use of the Gamma distribution
        approach developped by Kneller and Hinsen.

        :arg msd:    mean-squared displacement
        :arg beta:   beta parameter that represents motion homogeneity in the sample
        :arg scaleF: scaling factor
