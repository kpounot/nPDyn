...
class IN16B_XML:
    ...
    def getPSDValues(self):
        """ Extract the values for each detector tube and return then in a numpy array
            using the same value range for each tube. 

        """

        #_Computes the siez of the detector tube.
        size = (int(self.valList[self.nameList == 'tube1'][0]) - 1) / self.numTubes
