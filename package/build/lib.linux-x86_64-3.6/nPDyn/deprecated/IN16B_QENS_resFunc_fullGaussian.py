...
class ResPlot(QDialog):
    def __init__(self, dataFiles=None):
        ...
        try:
            ...
            self.ECFile = QFileDialog().getOpenFileName()[0]
            ECData = h5process.processData(self.ECFile, karg['binS'])
...
#_Definitions of the slots for the plot window
    ...
    def analysisPlot(self):
        ...
        for k, dataSet in enumerate(self.dataList):
            ...
            for j, qWiseData in enumerate(dataSet.intensities):    
                ...
                g1List.append(self.resFitList[k][j][0][3])
            ...
            ax2.errorbar(qList, g1List, marker='o', 
                    label='...' + self.dataFiles[k][self.dataFiles[k].rfind('/'):])
    ...
    def resPlot(self):
        ...
        for k, dataSet in enumerate(self.dataList):
            ...
            g0        = self.resFitList[k][qValIdx][0][2]
            g1        = self.resFitList[k][qValIdx][0][3]
            ...
            ax.plot(dataSet.energies, [self.resFunc(val, 1, S, g0, g1, shift, bkgd)
